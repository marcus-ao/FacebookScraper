...
export interface ReviewStateRecord {
  ...
  /** web/DESIGN.md：本轮固定 null，界面不得显示虚构用户名。 */
  readonly actor?: null
...
export interface ImageAsset {
  ...
  /** false = 缺德语图，当前显示的是原图。**这条不许藏**（DESIGN.md）。 */
