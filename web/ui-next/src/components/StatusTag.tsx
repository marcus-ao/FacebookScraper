 ...
 * 终态：她已经做完决定、不会再回来的两个。
 *
 * 列表行用它整行降饱和，把终态和 `not_ready` 区分开（DESIGN.md §7 第 3 条）——
