 ...
 *
 * ⛔ 不许进 localStorage 的东西（REACT_MIGRATION_PLAN.md §6.1 / D9 旁注）：
 *
 ...
 *
 * 旧 UI 实测 localStorage / sessionStorage / cookie 全空
 * （BASELINE_BEHAVIOR.md §1）。这是这个应用的第一个本地持久化，
 * 所以边界从第一天就写死在这里，而不是等它长出第二个用途。
 *
...
/**
 * 左侧导航是否折叠。**默认展开**（UI_ARCHITECTURE_PROPOSAL.md §2.1 第 3 条）。
 *
