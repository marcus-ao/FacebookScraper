...
|---|---|
| **本文件** | **现状行为，重构的回归清单** |
| SCREEN_INVENTORY.md | 六个界面各自的任务、控件、状态、截图 |
| [UI_AUDIT.md](UI_AUDIT.md) | 按 P0–P3 分级的 UX 问题与处理方向 |
| UI_ARCHITECTURE_PROPOSAL.md | 目标信息架构与 Ant Design 映射 |
| [REACT_MIGRATION_PLAN.md](REACT_MIGRATION_PLAN.md) | Vue → React + TypeScript 的迁移顺序与回归策略 |
| [DESIGN.md](DESIGN.md) | 未来设计系统草案 |
| OPEN_QUESTIONS.md | 需要产品决定、我不替你定的事 |
| [../../web/DESIGN.md](../DESIGN.md) | **接口契约的真相源**，本文件不覆盖它 |
...
下面每一条我都没有替你下结论。要动它们之前先看 OPEN_QUESTIONS.md。
