...
def stage_c(page, ui):
    ...
    for width,height,target in [(1366,768,12),(1920,1080,18)]:
        ...
        page.screenshot(path=str(ROOT/f"docs/ui-refactor/screenshots/final-review@{width}x{height}.png"))
...
def stage_e(page, ui):
    ...
    for width,height,target in [(1366,768,12),(1920,1080,18)]:
        ...
        measurements[str(width)]=metric
        page.screenshot(path=str(ROOT/f'docs/ui-refactor/screenshots/final-history@{width}x{height}.png'))
...
def main():
    ...
    if args.stage=='ALL':
        ...
        for stage in STAGES:
            ...
            report=json.loads((ROOT/'docs/ui-refactor'/f'browser-stage-{stage.lower()}.json').read_text('utf-8'))
        ...
        (ROOT/'docs/ui-refactor/browser-stage-all.json').write_text(json.dumps(output,ensure_ascii=False,indent=2),encoding='utf-8')
    ...
    with BrowserFixture() as fx:
        ...
        with sync_playwright() as driver:
            ...
            try:
                ...
                output=ROOT/"docs/ui-refactor"/f"browser-stage-{args.stage.lower()}.json"
                ...
                if not page.is_closed():
                    (ROOT/'docs/ui-refactor/browser-failure.txt').write_text(page.locator('body').aria_snapshot(),encoding='utf-8')
                    page.screenshot(path=str(ROOT/'docs/ui-refactor/screenshots/browser-failure.png'))
                raise
            finally:
                context.close()
