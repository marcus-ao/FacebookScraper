...
| 合作帖 | 你发现的问题，已修 | ✅ 归档从 756 涨到 **1019 篇**，见下 |
| **第 8 步** | **增量复测**（合作帖修完后） | ⬅️ **轮到你**，约 5 分钟 |
| **第 9 步** | **装每日计划任务** | ⬅️ 第 8 步通过之后再装 |
...
|---|---:|---:|---:|---|
| Instagram | 1500 | 756 篇 | **1019 篇** | **加回 263 篇合作帖**（你发现的问题，见下） |
| Facebook | 47 | 46 篇 | **46 篇** | 不变（FB 没有合作帖这个机制） |
...
archive\in_neakasa.tech\index.html         1019 篇（含 263 篇合作帖，带绿色标签）
```
...
你上次已经跑过一轮，**Facebook 那半边验收通过了**。这次要复测的是
**合作帖修完之后的 Instagram**——上次它只认出 1 篇自家帖子，
现在应该能认出 36 篇左右。

这次跑还会顺带验证两件上次没验证到的事：**新帖的图片能不能下下来**
（上次两个平台都是 0 新增，下载环节根本没被触发），以及**运行状态记录**。
...
新增 0 篇 · 本账号 36 篇（2026-06-06 ~ 2026-08-27）· 丢弃 3 · 归档最新 2026-08-27
```

**要看的是「本账号 N 篇」那个数**：

- IG 应该是 **30 篇以上**。如果又变成 1 篇，说明合作帖那条修复没生效，告诉我。
...
那是新加的一道闸：它宁可停下来报错，也不把"没看到"伪装成"没新帖"。
把整段输出发我。
...
## 第 9 步 · 装每日计划任务（第 8 步通过之后再做）

> ⚠️ **这一步我故意没替你做。** 任务一装上，**从那一刻起每天就会真的
> 去访问一次 Facebook 和 Instagram**——方案 B 那个"累积风险"就是从这里
> 开始计的。所以要等第 8 步确认增量是好的，再装。
> 装一个每天准时失败的东西，比不装更糟。
