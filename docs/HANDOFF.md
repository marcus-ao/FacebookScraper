...
### 1.12 Facebook 作者身份修复（2026-09-18）
...
**待真实联调：** 没有完整捕获文件或服务机业务目录，未补入那 16 篇帖子，未验证其图片 URL 有效性、
